...
export function LoginForm({ className, searchParams, ...props }: React.ComponentProps<"div"> & { searchParams?: Message }) {
  return (
        ...
        <CardContent className="grid p-0 md:grid-cols-3">
          <form className="p-8 md:p-6">
            <div className="flex flex-col gap-6">
              ...
              <SubmitButton type="submit" className="w-full" formAction={signInAction}>
                Login
              </SubmitButton>
